...
<div class='legend-scale'>
  <ul class='legend-labels'>
     <li><span style='background:red;opacity:0.7;'></span>Thermal</li>
     <li><span style='background:yellow;opacity:0.7;'></span>Solar</li>
     <li><span style='background:blue;opacity:0.7;'></span>Hydro</li>
     <li><span style='background:cyan;opacity:0.7;'></span>Wind</li>
     <li><span style='background:darkviolet;opacity:0.7;'></span>Nuclear</li>
...
folium_static(m.get_root().add_child(macro))
st.text("")
